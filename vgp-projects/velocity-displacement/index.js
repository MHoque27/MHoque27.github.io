...
(function(window, opspark, finiteArtillery) {
  const
  ...
  ship.update = function() {
     ...
     */
    finiteArtillery.phyz.updateVelocity(this, this.propulsion, this.propulsion);
...
}(window, window.opspark, window.finiteArtillery));
